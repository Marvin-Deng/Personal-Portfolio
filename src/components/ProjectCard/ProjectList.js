...
const ProjectList = [
    {
        imgSrc: taskbruin,
        title: "TaskBruin",
        description: "TaskBruin is a web application for UCLA students that serves as a centralized hub where a service is listed in exchange for meal swipes. Possible services that can be uploaded include laundry services, arrangements for carpooling or sharing transportation, and food delivery from dining halls. Users are able to create and delete their own tasks, accept and un-accept tasks that other users have created, and view a list of tasks they have created and accepted.",        
